...
public class PaymentDetails extends PayPalModel {
	 ...
	 * Setter for shipping
	 */
	public PaymentDetails setShipping(String shipping) {
	 ...
	 * Setter for subtotal
	 */
	public PaymentDetails setSubtotal(String subtotal) {
	 ...
	 * Setter for tax
	 */
	public PaymentDetails setTax(String tax) {
		this.tax = tax;
		return this;
	}
	 ...
	 * Setter for fee
	 */
	public PaymentDetails setFee(String fee) {
		this.fee = fee;
		return this;
	}
	 ...
	 */
	public PaymentDetails setHandlingFee(String handlingFee) {
	 ...
	 * Setter for giftWrap
	 */
	public PaymentDetails setGiftWrap(String giftWrap) {
