...
public class SimpleMail {
	...
	public static void sendMail(String subject, String body, String sender, String recipients, String mailHost,
			final String mailUser, final String mailPassword) throws Exception {
	...
	public static void main(String args[]) throws Exception {
		...
		SimpleMail.sendMail("test", "test", "panawe@gmail.com", "panawe@gmail.com,panawe@yahoo.fr", "smtp.gmail.com",
				"panawe", "pass");
