...
CREATE TABLE USERS (
     ...
     , CITY_ORIGIN VARCHAR(150)
     , MOD_BY BIGINT NOT NULL DEFAULT 1
     , PHONE VARCHAR(20)
     , ADDRESS TEXT
     , CITY_RESIDENCE VARCHAR(150)
     , PIC VARCHAR(100)
     , COUNTRY_ORIGIN BIGINT
     , COUNTRY_RESIDENCE BIGINT
     , ZIP_CODE  VARCHAR(10)
...
CREATE TABLE TRANSACTION (
     ...
     , CONSTRAINT FK_PAYMENT_HISTORY_PJ_1 FOREIGN KEY (PROJECT_ID)
...
CREATE TABLE MARIAGE (
       MARIAGE_ID BIGINT NOT NULL AUTO_INCREMENT
     , HUSBAND BIGINT NOT NULL
     , WIFE BIGINT NOT NULL
     , MARIAGE_DATE TIMESTAMP NOT NULL
     , DIVORCE_DATE TIMESTAMP NOT NULL
     , CREATE_DATE TIMESTAMP NOT NULL
     , MOD_DATE TIMESTAMP NOT NULL
     , MOD_BY BIGINT NOT NULL 
     ...
     , INDEX (HUSBAND)
     , INDEX (WIFE)
     , CONSTRAINT FK_SPOUSES_U1 FOREIGN KEY (HUSBAND)
                  REFERENCES USERS (USER_ID) 
     , CONSTRAINT FK_SPOUSES_U2 FOREIGN KEY (WIFE)
                  REFERENCES USERS (USER_ID) 
);

CREATE UNIQUE INDEX UNIQUE_MARIAGE ON MARIAGE (HUSBAND ASC, WIFE ASC);
