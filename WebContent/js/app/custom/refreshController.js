(function () {
    ...
    angular.module('app').controller('refreshCtrl', function($scope, $interval, $log, $http){
		var c = 0;
		$interval(function(){
			$http({ method: 'POST', url: 'http://www.agwedc.com/service/user/getMessagingUsers', data : null }).
			...
			$http({ method: 'POST', url: 'http://www.agwedc.com/service/user/getGuestCount', data : null }).
	        success(function (data, status, headers, config) {
	        	$log.info("Call Successful"); 
