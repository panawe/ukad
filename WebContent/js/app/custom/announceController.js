  	        ...
  	        */
  	        ...
  	        $scope.theUser = $cookieStore.get('theUser');
  	         ...
  	         var announceUploader = $scope.announceUploader = new FileUploader({
  	 	            url: 'http://agwe-esoftsystems.rhcloud.com/service/announce/receiveFile'
  	 	        });
  	 	    ...
  	 	    $scope.createAnnounce = function() {  
  	 	      	...
  	 	      	$http({ method: 'POST', url: 'http://agwe-esoftsystems.rhcloud.com/service/announce/createAnnounce', data: this.theAnnounce }).
 ...
 */
  $scope.getAllAnnounces = function() {
       ...
       $http({ method: 'POST', url: 'http://agwe-esoftsystems.rhcloud.com/service/announce/getAllAnnounces', data: null }).
       success(function (data, status, headers, config) {
