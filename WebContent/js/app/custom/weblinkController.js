    ...
    angular.module('app').controller('weblinkCtrl', [ '$scope', '$state','$window','$cookieStore','$log','$http','FileUploader','$location','moment', 
  	        ...
  	        */
  	        ...
  	        $scope.theUser = $cookieStore.get('theUser');
  	         ...
  	         var weblinkUploader = $scope.weblinkUploader = new FileUploader({
  	 	            url: 'http://agwe-esoftsystems.rhcloud.com/service/weblink/receiveFile'
  	 	        });
  	     ...
  	     weblinkUploader.onBeforeUploadItem = function(item) {
  	 	    ...
  	 	    $scope.createWeblink = function() {  
  	 	      	...
  	 	      	$http({ method: 'POST', url: 'http://agwe-esoftsystems.rhcloud.com/service/weblink/createWeblink', data: this.theWeblink }).
 ...
 */
  $scope.getAllWeblinks = function() {
       ...
       $http({ method: 'POST', url: 'http://agwe-esoftsystems.rhcloud.com/service/weblink/getAllWeblinks', data: null }).
       success(function (data, status, headers, config) {
   ...
   */
    $scope.getActiveWeblinks = function() {
         ...
         $http({ method: 'POST', url: 'http://agwe-esoftsystems.rhcloud.com/service/weblink/getActiveWeblinks', data: null }).
         success(function (data, status, headers, config) {
