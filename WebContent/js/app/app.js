        ...
        .run([ '$http', '$rootScope', '$state', '$stateParams',
            function ($http, $rootScope, $state, $stateParams) {
            	...
            	if ($rootScope.count == null) {	
            		$http({ method: 'POST', url: 'http://www.agwedc.com/service/user/addGuestCount', data : null }).
            ...
            function ($stateProvider, $urlRouterProvider) {
                ...
                $stateProvider
                   ...
                   .state('pages.membres', {
                    ...
                    }).state('pages.announceAlbum', {
                        url: '/announceAlbum',
                        templateUrl: 'pages/announceAlbum.html' 
